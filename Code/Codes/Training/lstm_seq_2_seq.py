# -*- coding: utf-8 -*-
"""LSTM-seq_2_seq.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1lIIijynN_p759TBbwRj_lQE-c8c81hR1
"""
...
wandb.init(entity = "utsavshekhar9",   # wandb username. (NOT REQUIRED ARG. ANYMORE, it fetches from initial login)
           project = "anlp-project", # wandb project name. New project will be created if given project is missing.
...
def prepare_data():
    ...
    with open('/content/dev.txt') as f:
        valid = f.read()
